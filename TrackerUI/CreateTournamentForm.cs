...
namespace TrackerUI
{
    public partial class CreateTournamentForm : Form, IPrizeRequester, ITeamRequester
    {
        ...
        public void PrizeComplete(PrizeModel model)
        {
            ...
            // Take the PrizeModel and put int into our list of selected prizes
        ...
        private void createTournamButton_Click(object sender, EventArgs e)
        {
            // Valid data
            decimal fee = 0;
            ...
            if(!feeAcceptable)
            {
                MessageBox.Show("You nee to enter a valid Entry Fee.",
                    "Invalid Fee",
            ...
            tm.TournamentName = tournamentLabelValue.Text;
            tm.EntryFee = fee;
